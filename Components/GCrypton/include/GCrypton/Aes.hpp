...
public:
    ...
    static_assert(KEY_BYTES_COUNT == 16 || KEY_BYTES_COUNT == 24 || KEY_BYTES_COUNT == 32, 
        "Invalid AES key size. Supported sizes are 128, 192, or 256 bits.");
    ...
    std::array<std::uint8_t, 16U> Encrypt(std::span<uint8_t, 16U> data, KeyType key);

// private:
    static constexpr std::array<std::uint8_t, 256U> S_box = { 0x63U, 0x7cU, 0x77U, 0x7bU, 0xf2U, 0x6bU, 0x6fU, 0xc5U, 0x30U, 0x01U, 0x67U, 0x2bU, 0xfeU, 0xd7U, 0xabU, 0x76U,
